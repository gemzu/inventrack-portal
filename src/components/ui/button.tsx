...
default: "bg-[var(--btn-bg)] text-[var(--btn-fg)] border-[var(--btn-border)] shadow-[var(--btn-shadow)] hover:brightness-105 hover:shadow-md active:brightness-95 disabled:opacity-45",
        brand:
          "border-transparent bg-primary text-primary-foreground shadow-[0_8px_24px_-8px_var(--brand-1)] hover:brightness-110 hover:shadow-[0_10px_30px_-8px_var(--brand-1)] active:brightness-95",
        outline:
